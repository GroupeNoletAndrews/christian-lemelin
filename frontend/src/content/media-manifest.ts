...
export const MEDIA_MANIFEST: string[] = [
  "photos/fabrication/mobilier-hospitalier-plan-travail.jpg",
  ...
  "photos/realisations/mobilier-hospitalier-en-inox/3.jpg"
]
